    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        customdates_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                customdates_btn.setBackgroundResource(R.drawable.switch_on_weight);
        ...
        year_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                year_btn.setBackgroundResource(R.drawable.switch_on_weight);
        ...
        month_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                month_btn.setBackgroundResource(R.drawable.switch_on_weight);
        ...
        week_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                week_btn.setBackgroundResource(R.drawable.switch_on_weight);
