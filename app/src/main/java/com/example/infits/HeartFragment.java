    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        weightfrag.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Navigation.findNavController(v).navigate(R.id.action_fragment_Heart_to_weightFragment);
            }
        });
        ...
        stepfrag.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(v).navigate(R.id.action_fragment_Heart_to_stepsFragment);
            }
        });
        ...
        sleepfrag.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(v).navigate(R.id.action_fragment_Heart_to_sleepFragment);
            }
        });
        ...
        waterfrag.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(v).navigate(R.id.action_fragment_Heart_to_waterFragment);
            }
        });
