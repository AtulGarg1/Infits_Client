    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        customdates_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                customdates_btn.setBackgroundResource(R.drawable.switch_on_water);
        ...
        year_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                year_btn.setBackgroundResource(R.drawable.switch_on_water);
        ...
        month_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                month_btn.setBackgroundResource(R.drawable.switch_on_water);
        ...
        week_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                week_btn.setBackgroundResource(R.drawable.switch_on_water);
